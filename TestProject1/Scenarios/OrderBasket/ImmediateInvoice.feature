Feature: ImmediateInvoice

 @TestingOrderWithReleasePriorityImmediate
  Scenario: Changing the release priority to immediate
    ...
    And I enter P/O Reference code "INV", Quantity 5, seller "Streamline Distribution"  
